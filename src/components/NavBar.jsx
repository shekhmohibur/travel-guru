...
const NavBar = () => {
  ...
  return (
    <div
      className={`${
        scrolled &&
        "bg-white/30 backdrop-blur-md shadow-md shadow-black/20 animate__animated animate__backInDown duration-150"
      } top-0 py-4`}
    >
        ...
        <div className="flex gap-4 relative">
          ...
          <Link to={"/"}>
            <img
              ...
              className={`${
                location.pathname === "/" ||
                location.pathname === `/place/${placeId}`
                  ? "invert"
                  : ""
              } w-28 md:w-40`}
            />
          ...
          {menuOpen && (
            <div className="absolute flex flex-col gap-3 lg:hidden top-20 animate__animated animate__backInLeft animateMenu bg-black/80 p-5 shadow-white/20 shadow-[0_0_5px_rgba(0,0,0,0.3)]">
              ...
              <label
                className={`input md:hidden outline-none bg-transparent border-b border-white border-t-0 border-l-0 border-r-0 text-white placeholder:text-white lg:w-80`}
              >
            ...
            <label
              className={`hidden ${
                ...
                location.pathname === "/auth/register"
                  ? ""
                  : "md:flex"
              } input outline-none bg-white/20 shadow-[0_0_5px_rgba(0,0,0,0.3)] shadow-white text-white placeholder:text-white text-lg lg:w-80 `}
            >
              <IoSearch className="h-[1em] opacity-50" />
